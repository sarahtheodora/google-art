<div>
	<div>
        <div>
            <div class="-mt-16 bg-cover bg-center bg-no-repeat" style="background-image: url('{{ $entity['0']->background }}'); height: 25rem;"></div>
            <div class="px-5 md:px-24">
                <h1 class="text-center text-4xl mt-5 text-gray-800">{{ $entity['0']->name  }}</h1>
                ...
                <div class="flex justify-center">
                    <p class="text-sm text-gray-700 xl:px-56">
                        {!! nl2br($entity['0']->description) !!}
                    </p>
                </div>
            </div>
        </div>
