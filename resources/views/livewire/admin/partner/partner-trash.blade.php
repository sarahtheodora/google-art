<div>
    <h1 class="text-center text-2xl mt-3">Partner Trash</h1>
	{{-- <Table 1> --}}
				...
				<tbody class="bg-white">
					...
					<tr>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
							<button wire:click="kembalikan('{{ $partner->id }}')" class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">
